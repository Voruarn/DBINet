...
def get_argparser():
    ...
    parser.add_argument("--num_classes", type=int, default=2,
                        help='num_classes')
    parser.add_argument("--dataset", type=str, default='LC8BAS',
                choices=['LC8BAS'], help='Name of dataset')

    parser.add_argument("--model", type=str, default='DBINet',
                    help='model name:[DBINet]')
